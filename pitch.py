...
def create_tree():
    ...
    #Octave 2                     3                    4                    5                    6                # Note
            (63.6,67.4,"C2"),     (127.1,134.7,"C3"),  (255.0,270.0,"C4"),  (509.0,538.8,"C5"),  (1017.1,1077.6,"C6"), # C 
            (67.4,71.4,"C#2"),    (134.7,142.7,"C#3"), (270.0,286.0,"C#4"), (538.8,570.9,"C#5"), (1077.6,1141.7,"C#6"), # C#
            (71.4,75.6,"D2"),     (142.7,151.2,"D3"),  (286.0,303.0,"D4"),  (570.9,604.8,"D5"),  (1141.7,1209.6,"D6"), # D
            (75.6,80.1,"D#2"),    (151.2,160.2,"D#3"), (303.0,321.0,"D#4"), (604.8,640.8,"D#5"), (1209.6,1281.5,"D#6"), # D#
            (80.1,84.9,"E2"),     (160.2,169.7,"E3"),  (321.0,340.0,"E4"),  (640.8,678.9,"E5"),  (1281.5,1357.7,"E6"), # E
            (84.9,89.9,"F2"),     (169.7,179.8,"F3"),  (340.0,360.0,"F4"),  (678.9,719.2,"F5"),  (1357.7,1438.4,"F6"), # F
            (89.9,95.3,"F#2"),    (179.8,190.5,"F#3"), (360.0,381.0,"F#4"), (719.2,762.0,"F#5"), (1438.4,1524.0,"F#6"), # F#
            (95.3,100.9,"G2"),    (190.5,201.8,"G3"),  (381.0,404.0,"G4"),  (762.0,807.3,"G5"),  (1524.0,1614.6,"G6"), # G
            (100.9,106.9,"G#2"),  (201.8,213.8,"G#3"), (404.0,428.0,"G#4"), (807.3,855.3,"G#5"), (1614.6,1710.6,"G#6"), # G#
            (106.9,113.27,"A2"),  (213.8,226.5,"A3"),  (428.0,453.0,"A4"),  (855.3,906.2,"A5"),  (1710.6,1812.3,"A6"), # A
            (113.27,120.0,"A#2"), (226.5,240.0,"A#3"), (453.0,480.0,"A#4"), (906.2,960.1,"A#5"), (1812.3,1920.1,"A#6"), # A#
            (120.0,127.1,"B2"),   (240.0,255.0,"B3"),  (480.0,509.0,"B4"),  (960.1,1017.1,"B5"), (1920.1,2034.3,"B6"),  # B
...
# hardcoded wb file
wb = openpyxl.load_workbook('data/Susanna C Scale No Vibrato No Piano.xlsx')
